...
output_folder_path = "D:\Kevin Thomas\ASU\3rd Semester\MC\Project\MCProject\Data\Output\Final\RawData\";
...
for K = 1:length(dir_info)
    ...
    data_table_transpose = array2table(table2array(raw_data_table).');
